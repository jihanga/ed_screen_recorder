...
import static com.ed_screen_recorder.ed_screen_recorder.Constants.GENERAL_ERROR;
        ...
        try {
            if (!mWasUriSet) {
                if (outputPath != null) {
                    ...
                    observer = new FileObserver(String.valueOf(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM)), HBRecorder.this);
                }
